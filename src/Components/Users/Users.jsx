...
export default function Users() {
    ...
    async function handleUpdate(values) {
        ...
        setLoading(true)
        console.log(values);
        let { data } = await axios.patch(`https://dalilalhafr.com/api/auth/updateUser/${values._id}`, { name: values.name, role: values.role }, { headers })
        console.log(data);
        if (data.status == true) {
    ...
    return <>
            ...
            <div className='w-100 h-100  bg-body-secondary bg-opacity-50 fixed-top row justify-content-center align-content-center'>
                <div className='col-4'>
                    <form onSubmit={formik.handleSubmit} className='w-100 my-5  p-5 bg-light rounded-3 shadow '>
                        ...
                        <label for="email" class="form-label mt-2 ">role</label>
        ...
        <div className=''>
            ...
            </div> : <div className='col-8 mx-auto my-5'>
