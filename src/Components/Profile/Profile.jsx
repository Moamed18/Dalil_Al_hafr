...
export default function Profile() {
    ...
    return <>
        ...
        <div className=' w-100'>
            ...
            <div className='col-9 bg-light shadow-lg  mx-auto justify-content-evenly  p-5 rounded-5 mt-5 '>
                <div className="row">
                    ...
                    <div className='col-6  align-self-center p-0 text-center mx-auto mt-4'>
